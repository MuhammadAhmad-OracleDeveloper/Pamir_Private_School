...
// ---    Wed Jun 24 11:24:25 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblLeavePkgMasterImpl extends EntityImpl {
    /**
    ...
    public static final int PKGNAME = AttributesEnum.PkgName.index();
    ...
    /**
     * Gets the attribute value for PkgName, using the alias name PkgName.
     * @return the value of PkgName
     */
    public String getPkgName() {
        return (String) getAttributeInternal(PKGNAME);
    }

    /**
     * Sets <code>value</code> as the attribute value for PkgName.
     * @param value value to set the PkgName
     */
    public void setPkgName(String value) {
        setAttributeInternal(PKGNAME, value);
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.ERP.EO.TblLeavePkgMaster");
    }
