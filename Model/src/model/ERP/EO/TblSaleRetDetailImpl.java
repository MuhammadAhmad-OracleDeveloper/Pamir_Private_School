...
// ---    Thu Jun 25 14:31:34 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblSaleRetDetailImpl extends EntityImpl {
    /**
    ...
    public static final int SALERETMASTERID = AttributesEnum.SaleRetMasterId.index();
    ...
    /**
     * Gets the attribute value for SaleRetMasterId, using the alias name SaleRetMasterId.
     * @return the value of SaleRetMasterId
     */
    public BigDecimal getSaleRetMasterId() {
        return (BigDecimal) getAttributeInternal(SALERETMASTERID);
    }

    /**
     * Sets <code>value</code> as the attribute value for SaleRetMasterId.
     * @param value value to set the SaleRetMasterId
     */
    public void setSaleRetMasterId(BigDecimal value) {
        setAttributeInternal(SALERETMASTERID, value);
    }
    ...
    /**
     * @return the associated entity TblSaleRetMasterImpl.
     */
    public TblSaleRetMasterImpl getTblSaleRetMaster() {
        return (TblSaleRetMasterImpl) getAttributeInternal(TBLSALERETMASTER);
    }

    /**
     * Sets <code>value</code> as the associated entity TblSaleRetMasterImpl.
     */
    public void setTblSaleRetMaster(TblSaleRetMasterImpl value) {
        setAttributeInternal(TBLSALERETMASTER, value);
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.ERP.EO.TblSaleRetDetail");
    }
