...
// ---    Wed Jun 24 11:37:16 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblSaleRetMasterImpl extends EntityImpl {
    /**
    ...
    public static final int TBLSALERETDETAIL = AttributesEnum.TblSaleRetDetail.index();
    public static final int TBLSALEINVMASTER = AttributesEnum.TblSaleInvMaster.index();

    /**
     * This is the default constructor (do not remove).
     */
    public TblSaleRetMasterImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.ERP.EO.TblSaleRetMaster");
    }
     ...
     */
    public RowIterator getTblSaleRetDetail() {
        return (RowIterator) getAttributeInternal(TBLSALERETDETAIL);
    }

    /**
     * @return the associated entity TblSaleInvMasterImpl.
     */
    public TblSaleInvMasterImpl getTblSaleInvMaster() {
        return (TblSaleInvMasterImpl) getAttributeInternal(TBLSALEINVMASTER);
    }

    /**
     * Sets <code>value</code> as the associated entity TblSaleInvMasterImpl.
     */
    public void setTblSaleInvMaster(TblSaleInvMasterImpl value) {
        setAttributeInternal(TBLSALEINVMASTER, value);
    }
